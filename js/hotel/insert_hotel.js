...
const insertHotel = async (event) => {
  ...
  const targetURL = 'https://asia-southeast2-pasabar.cloudfunctions.net/Insert-Hotel'
  ...
  try {
    ...
    if (data.status === false) {
      ...
      showAlert('Hotel data inserted successfully!', 'success')
...
document.getElementById('newHotelForm').addEventListener('submit', insertHotel)
