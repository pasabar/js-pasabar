...
const insertCatalog = async (event) => {
  ...
  const targetURL =
    "https://asia-southeast2-pasabar.cloudfunctions.net/Insert-Catalog";
  ...
  const requestOptions = {
    ...
    body: JSON.stringify({
      ...
      status:
        document.getElementById("newStatus").value === "active" ? true : false,
    }),
    redirect: "follow",
  };
...
document
  .getElementById("newCatalogForm")
  .addEventListener("submit", insertCatalog);
