...
const insertRestaurant = async (event) => {
  ...
  const targetURL = 'https://asia-southeast2-pasabar.cloudfunctions.net/InsertRestoran'
  ...
  try {
    ...
    if (data.status === false) {
      ...
      showAlert('Restaurant data inserted successfully!', 'success')
...
document.getElementById('newResForm').addEventListener('submit', insertRestaurant)
